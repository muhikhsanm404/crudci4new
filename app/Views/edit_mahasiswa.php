            ...
            <div class="row md-5 pb-4">
              ...
              <div class="col-sm-10">
                <input type="id" class="form-control"
                  id="nim" name="nim" autofocus required
                  value="<?= old('nim') ? old('nim') : $mhs->nim ?>" />
              </div>
            </div>
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control"
                  ...
                  value="<?= old('nama') ? old('nama') : $mhs->nama ?>" />
              </div>
            </div>
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <input type="email" class="form-control"
                  ...
                  value="<?= old('email') ? old('email') : $mhs->email ?>" />
              </div>
            </div>
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <select name="jurusan" class="form-select">
                  <option value="Sistem Komputer"
                    <?= $isSelected(old('jurusan'), 'Sistem Komputer') ?>>
                    Sistem Komputer
                  </option>
                  <option value="Sistem Informasi"
                    <?= $isSelected(old('jurusan'), 'Sistem Informasi') ?>>
                    Sistem Informasi
                  </option>
                  <option value="Teknik Informatika"
                    <?= $isSelected(old('jurusan'), 'Teknik Informatika') ?>>
                    Teknik Informatika
                  </option>
                </select>
              </div>
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <input type="address" class="form-control"
                  ...
                  value="<?= old('alamat') ? old('alamat') : $mhs->alamat ?>" />
              </div>
            </div>
