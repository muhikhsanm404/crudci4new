        ...
        <div class="row">
          <form action="<?= base_url('tambah') ?>" method="POST">
            ...
            <div class="row md-5 pb-4">
              ...
              <div class="col-sm-10">
                <input type="id" class="form-control <?= $isInvalid('nim') ?>" id="nim" name="nim" onkeyup="ceknim()" autofocus value="<?= old('nim') ?>" required />
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control <?= $isInvalid('nama') ?>" id="nama" name="nama" value="<?= old('nama') ?>" required />
                <div class="invalid-feedback">
                  <?= $errors['nama'] ?? '' ?>
                </div>
              </div>
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <input type="email" class="form-control <?= $isInvalid('email') ?>" id="email" name="email" required value="<?= old('email') ?>" />
                <div class="invalid-feedback">
                  <?= $errors['nama'] ?? '' ?>
                </div>
              </div>
